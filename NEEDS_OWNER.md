...
```
ينشر (HEAD الحالي): **إصلاح بحث الصالونات** (d9b47cf — صالون نسائي كان يفشل رغم 17 نتيجة) · **الإرسال 2ث بين الرسائل** (d9b47cf) · **زر نسخ الرمز** (d9b47cf) · **نصّ الموقع الإلزامي** (f6cdf09) · **إصلاح تصنيف الملحمة** (7c3365d) · **تخطيط الربط** · **الديسكتوب المتجاوب** (71718ef) · مرونة الكابتشا/التنقّل (620a1a2). بعده تحقّق: `curl -s https://app.dabbir.app/api/build-identity` (يتغيّر) + افتح /go بتبويب خفي، واختبر: «صالون نسائي أبها»→نتائج، شاشة الربط→زر «نسخ الرمز»، الإرسال أسرع.
