...
```
ينشر (HEAD الحالي): **إصلاح تصنيف الملحمة** (7c3365d) · **تخطيط الربط** · **الديسكتوب المتجاوب** (71718ef) · مرونة الكابتشا/التنقّل (620a1a2) · إصلاحات الرحلة السابقة. بعده تحقّق: `curl -s https://app.dabbir.app/api/build-identity` (يتغيّر) + افتح /go بتبويب خفي.
