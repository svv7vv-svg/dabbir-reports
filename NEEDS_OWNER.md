...
```
ينشر (HEAD الحالي): **الصفحة الرئيسية LANDING_V2** (4cbc752 — رحلة ٤ خطوات مصوّرة + «ليش دبّر؟») · **تسريع البحث** (919f6fa — سقف السلّم 6ث + استخراج أرقام mini) · **إصلاح التعديل بعد النتائج** (8763492) · **إصلاح بحث الصالونات** (d9b47cf) · **الإرسال 2ث** (d9b47cf) · **زر نسخ الرمز** (d9b47cf) · **نصّ الموقع** (f6cdf09) · **تصنيف الملحمة** (7c3365d) · **الربط + الديسكتوب** (71718ef) · الكابتشا/التنقّل (620a1a2). بعده تحقّق: `curl -s https://app.dabbir.app/api/build-identity` + تبويب خفي، واختبر: **الصفحة الرئيسية** (رحلة ٤ خطوات + ليش دبّر) · «صالون نسائي أبها»→نتائج · نتائج→«عدّل طلبي»→بحث جديد بلا تعليق · «نسخ الرمز» · الإرسال أسرع · **قِس زمن البحث** (صالون/ملحمة/مكيفات).
